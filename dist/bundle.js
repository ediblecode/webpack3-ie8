...
/******/ 	var hotCurrentHash = "3a0df25fe8015aa285b8"; // eslint-disable-line no-unused-vars
...
function square() {
  ...
  var example = function example() {
    var numbers = [];
    for (var _iterator = _arguments, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : (0, _getIterator3["default"])(_iterator);;) {
      var _ref;
